...
Copyright (c) 2020, Frederik Huld
All rights reserved.

This source file is a derived work from the Open Source project specified below.
Open Source components are used and modified to satisfy custom requirements.

Project: 
  Neware Reader https://github.com/FTHuld/neware_reader

License (BSD 2-Clause License): 
  https://github.com/FTHuld/neware_reader/blob/master/LICENSE
