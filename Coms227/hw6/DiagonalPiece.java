...
public class DiagonalPiece extends AbstractPiece
{
	...
	/**
	* Constructs a DiagonalPiece at the given position and givenIcon.
	* @param givenPosition
	* 	given Position value
	* @param givenIcon
	* 	given array of Icon
	*/
	public DiagonalPiece(Position givenPosition, Icon[] givenIcon) 
	{
		super(givenPosition, givenIcon);
		super.getCells()[0].setRowCol(0, 0);
		super.getCells()[1].setRowCol(1, 1);
		counter=0;
	}
