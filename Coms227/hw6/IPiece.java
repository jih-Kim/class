...
{
	/**
	* Constructs a IPiece at the given position and givenIcon.
	* @param givenPosition
	* 	given Position value
	* @param givenIcon
	* 	given array of Icon
	*/
	public IPiece(Position givenPosition, Icon[] givenIcon) 
	{
		super(givenPosition, givenIcon);
		super.getCells()[0].setRowCol(0, 1);
		super.getCells()[1].setRowCol(1, 1);
		super.getCells()[2].setRowCol(2, 1);
	}
