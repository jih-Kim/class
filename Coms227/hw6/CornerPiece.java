...
public class CornerPiece extends AbstractPiece
{
	...
	/**
	* Constructs a CornerPiece at the given position and givenIcon.
	* @param givenPosition
	* 	given Position value
	* @param givenIcon
	* 	given array of Icon
	*/
	public CornerPiece(Position givenPosition, Icon[] givenIcon) 
	{
	...
	*/
	...
	{
		counter++;
		super.getCells()[0].setPosition(sequence[counter%4]);
		super.getCells()[1].setPosition(sequence[(counter-1)%4]);
		super.getCells()[2].setPosition(sequence[(counter-2)%4]);
	}
}
