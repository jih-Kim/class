...
public class SnakePiece extends AbstractPiece
{
	...
	/**
	* Constructs a SnakePiece at the given position and givenIcon.
	* @param givenPosition
	* 	given Position value
	* @param givenIcon
	* 	given array of Icon
	*/
	public SnakePiece(Position givenPosition, Icon[] givenIcon) 
	{
		
		super(givenPosition, givenIcon);
		super.getCells()[0].setRowCol(0, 0);
		super.getCells()[1].setRowCol(1, 0);
		super.getCells()[2].setRowCol(1, 1);
		super.getCells()[3].setRowCol(1, 2);
		counter=12;
	}
	...
	*/
	...
	{
		counter++;
		super.getCells()[0].setPosition(sequence[counter%12]);
		super.getCells()[1].setPosition(sequence[(counter-1)%12]);
		super.getCells()[2].setPosition(sequence[(counter-2)%12]);
		super.getCells()[3].setPosition(sequence[(counter-3)%12]);
		if(counter==24)
			counter=12;
		//do nothing
	}
